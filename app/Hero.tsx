      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-4">Manan</h1>
          ...
          >
            ...
            >
              <Link href="https://linkedin.com/in/manan" target="_blank">
